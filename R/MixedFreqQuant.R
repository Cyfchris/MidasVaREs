...
#' @useDynLib MidasVaREs
#' @import dplyr
#' @import pracma
#' @importFrom Rcpp sourceCpp evalCpp
#-------------
MixedFreqQuant <- function(DataY,DataYdate,DataX,DataXdate,xlag,period,ovlap = TRUE,simpleRet = FALSE, mix = TRUE){
  nobs <- length(DataY)
...
.onUnload <- function (libpath) { library.dynam.unload("MidasVaREs", libpath)}
